    ...
    for idx, cp in enumerate(label, 1):
        ...
        if rtl:
            ...
            if direction not in [
                ...
                raise IDNABidiError(
                    "Invalid direction for codepoint at position {} in a right-to-left"
                    " label".format(idx)
                )
            # Bidi rule 3
            ...
            if direction not in ["L", "EN", "ES", "CS", "ET", "ON", "BN", "NSM"]:
                raise IDNABidiError(
                    "Invalid direction for codepoint at position {} in a left-to-right"
                    " label".format(idx)
                )
            # Bidi rule 6
    ...
    for pos, cp in enumerate(label):
        ...
        if intranges_contain(cp_value, idnadata.codepoint_classes["PVALID"]):
            ...
            try:
                ...
                raise IDNAError(
                    "Unknown codepoint adjacent to joiner {} at position {} in {}"
                    .format(_unot(cp_value), pos + 1, repr(label))
                )
...
def encode(
    ...
    if not isinstance(s, str):
        try:
            ...
            raise IDNAError(
                "should pass a unicode string to the function rather than a byte"
                " string."
            )
    if uts46:
