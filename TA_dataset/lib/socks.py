...
PRINTABLE_PROXY_TYPES = dict(
    list(zip(list(PROXY_TYPES.values()), list(PROXY_TYPES.keys())))
)
    ...
    def connect(self, dest_pair, catch_errors=None):
        ...
        try:
            ...
            if not catch_errors:
                ...
                printable_type = PRINTABLE_PROXY_TYPES[proxy_type]  # noqa

                msg = "Error connecting to proxy"
