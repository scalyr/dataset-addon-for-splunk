...
def get_ds_powerquery(ds_start_time):
    ds_query = { "query": "tag=\'alertStateChange\' status='TRIGGERED' | columns timestamp, app, silencedUntilMs, gracePeriod, lastRedAlertMs, reportedStatus, renotifyPeriod, lastTriggeredNotificationMinutes, description, severity, trigger, lastStatus, status", "startTime": ds_start_time }
    return ds_query
